...
import MenueItemsDelPartner from './MenueItemsDelPartner';
            ...
            >
              <Row>
                <Col lg={!topMenu ? 4 : 3} sm={6} xs={12} className="align-center-v navbar-brand">
                  ...
                  >
                    <img
                      src={!darkMode ? require(`../static/img/logo1.png`) : require(`../static/img/logo1.png`)}
                      style={{ maxWidth: '76px' }}
                      alt=""
                    />
                  </Link>
              ...
              <Layout className="atbd-main-layout">
                <Content>
                  ...
                  <Footer className="admin-footer" style={footerStyle}>
                    <Row>
                      <Col md={12} xs={24}>
                        <span className="admin-footer__copyright">2021 © AjivaInfotech Pvt Ltd</span>
                      </Col>
                      <Col md={12} xs={24}>
