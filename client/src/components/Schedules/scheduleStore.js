...
const cardsById = (state = {}, action) => {
  switch (action.type) {
    case 'ADD_CARD': {
      const { cardText, cardId, cardImage, listId, cardDate, cardTime } = action.payload;
      return {
        ...state,
        [cardId]: { text: cardText, _id: cardId, Image: cardImage, list_Id: listId, Date: cardDate, Time: cardTime },
      };
    }
