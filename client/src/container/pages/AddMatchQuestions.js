...
const AddMatchQuestions = () => {
  ...
  const [PairData1, setPairData1] = useState({
    pair_value: '',
    pair_answer: '',
  });
  const [PairData2, setPairData2] = useState({
    pair_value: '',
    pair_answer: '',
  });
  useEffect(() => {
  ...
  const HandleAddOptionValue = (e, index, fieldName) => {
  ...
  const handlesubmit = (fieldsValue, name) => {
    ...
    var Options = [
      {
        key: 'pair1',
        pair_answer: (PairData1?.pair_answer).replaceAll('"', "'"),
        pair_value: (PairData1?.pair_value).replaceAll('"', "'"),
      },
      {
        key: 'pair1',
        pair_answer: (PairData2?.pair_answer).replaceAll('"', "'"),
        pair_value: (PairData2?.pair_value).replaceAll('"', "'"),
      },
    ];
    //   console.log(OptionValues);
    OptionValues?.map((item, i) => {
      var GetOption = {
        key: 'pair' + (i + 3),
        pair_answer: (item?.pair_answer).replaceAll('"', "'"),
        pair_value: (item?.pair_value).replaceAll('"', "'"),
      };
      Options.push(GetOption);
    });
    console.log(Options);
    setexactanswer(Options);
    if (skills) {
      var meta = {};
      var payload = {
    ...
    // } else {
    //   notification.error({ message: 'Select Exact Answer' });
    // }
  };
  var active;
            ...
            {tabpane?.Details == true ? (
              <Cards>
                <Row gutter={30} className="skillrow">
                  ...
                  <Col md={18} xs={24} className="skillrow-inner">
                    <div className="greencol">
                      <div className="notes-pair">
                        <div className="notes-pair-inner1">
                          <svg
                        ...
                        <div className="notes-pair-inner2">
                          <p>
                            Enter pairs in correct order. Pairs will automatically shuffle while
                            <br /> showing to users.
                          </p>
                        </div>
                      </div>

                      <div className="flexgreen">
                        <div className="flexgreen-inner">
                          <Form.Item name="option1" label="Pair 1">
                            <CKEditor
                              editor={ClassicEditor}
                              contentStyle={{
                                height: 430,
                              ...
                              onChange={(event, editor) => {
                                ...
                                setPairData1({ ...PairData1, pair_value: data });
                              }}
                            />
                            ...
                            {/* <Editor
                              ...
                              onChange={selectedValue => {
                                setformData({ ...formData, option1: selectedValue.html });
                                setPairData1({ ...PairData1, pair_value: selectedValue.html });
                              }}
                              value={PairData1?.pair_value}
                            /> */}
                          </Form.Item>
                        </div>

                        <div className="flexgreen-inner">
                          <Form.Item name="pair1" label=" ">
                            ...
                            <CKEditor
                              ...
                              onChange={(event, editor) => {
                                ...
                                // console.log(data, '00000000000000000000');
                                //  setCkData(data);
                                setformData({ ...formData, pair1: data });
                                setPairData1({ ...PairData1, pair_answer: data });
                              }}
                            />
                            ...
                            {/* <Editor
                              ...
                              onChange={selectedValue => {
                                setformData({ ...formData, pair1: selectedValue.html });
                                setPairData1({ ...PairData1, pair_answer: selectedValue.html });
                              }}
                              value={PairData1?.pair_answer}
                  ...
                  <Col md={18} xs={24} className="skillrow-inner">
                    <div className="greencol flexgreen">
                      <div className="flexgreen-inner">
                        <Form.Item name="option2" label="Pair 2">
                          <CKEditor
                            editor={ClassicEditor}
                            contentStyle={{
                              height: 430,
                            ...
                            onChange={(event, editor) => {
                              ...
                              setPairData2({ ...PairData2, pair_value: data });
                            }}
                          />
                          {/* <Editor
                            // value={cssvalue}
                            ...
                            onChange={selectedValue => {
                              setformData({ ...formData, option2: selectedValue.html });
                              setPairData2({ ...PairData2, pair_value: selectedValue.html });
                            }}
                            value={PairData2?.pair_value}
                          /> */}
                        </Form.Item>
                      </div>
                      <div className="flexgreen-inner">
                        <Form.Item name="pairs" label=" ">
                          {/* <label style={{ visibility: 'hidden' }}>Pair</label> */}
                          <CKEditor
                            editor={ClassicEditor}
                            contentStyle={{
                            ...
                            onChange={(event, editor) => {
                              ...
                              // console.log(data, '00000000000000000000');
                              //  setCkData(data);
                              setformData({ ...formData, pairs: data });
                              setPairData2({ ...PairData2, pair_answer: data });
                            }}
                          />
                          ...
                          {/* <Editor
                            ...
                            onChange={selectedValue => {
                              setformData({ ...formData, pairs: selectedValue.html });
                              setPairData2({ ...PairData2, pair_answer: selectedValue.html });
                            }}
                            value={PairData2?.pair_answer}
                          /> */}
                        </Form.Item>
                      </div>
                    </div>
                  ...
                  {OptionValues?.map((item, index) => (
                    <Row gutter={24} style={{ display: 'flex', margin: '0px' }}>
                      <Col md={12} xs={24}>
                        <Form.Item name="pair">
                          <label>Pair {index + 3} </label>
                          <CKEditor
                            editor={ClassicEditor}
                            contentStyle={{
                              height: 430,
                            ...
                            onChange={(event, editor) => {
                              ...
                              // console.log(data, '00000000000000000000');
                              //  setCkData(data);
                              HandleAddOptionValue(data, index, 'pair_value');
                            }}
                          />
                          {/* <Editor
                            // value={cssvalue}
                            ...
                            onChange={e => HandleAddOptionValue(e, index, 'pair_value')}
                        ...
                        <Form.Item name="pairss">
                          ...
                          <CKEditor
                            ...
                            onChange={(event, editor) => {
                              ...
                              // console.log(data, '00000000000000000000');
                              //  setCkData(data);
                              HandleAddOptionValue(data, index, 'pair_answer');
                            }}
                          />
                          {/* <Editor
                            // value={cssvalue}
                            ...
                            onChange={e => HandleAddOptionValue(e, index, 'pair_answer')}
              ...
              <>
                <Cards>
                  ...
                  {showsolutionvalue == true ? (
                    <Col md={24} xs={24} style={{ padding: 'inherit' }}>
              ...
              <>
                <Cards>
                  <Col md={24} xs={24} style={{ padding: '0px' }}>
                    <label>
...
export default AddMatchQuestions;
