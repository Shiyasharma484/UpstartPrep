            ...
            <div className="payment-success-main">
              <div className="payment-success-inner">
                ...
                <div className="payment-text">
                  <p className="payment-sucess">Payment Successful!</p>
                  <p className="transaction-number">Transaction Number: 1453545121</p>
                </div>
              </div>
            </div>
          </Col>
                  ...
                  <Form name="sDash_validation-form" onFinish={HandleSubmitForm}>
                    <Row gutter={30} className="ContactForm">
                      <Col md={12} xs={24} sm={24}>
                        ...
                        <Col md={12} sm={24} xs={24} className="mbottomInput">
                          <Form.Item name="message" className="contact_input">
