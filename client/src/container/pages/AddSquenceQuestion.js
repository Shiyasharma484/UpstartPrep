...
const AddSquenceQuestion = () => {
  ...
  const HandleAddOptionValue = (e, index) => {
    ...
    const updatePrice = OptionValues?.map((value, i) =>
      index == i ? Object.assign(value, { ['sequence']: e }) : value,
    );
  ...
  // console.log(questiontype_id);
  const handlesubmit = (fieldsValue, name) => {
    // if (exactanswer.key && exactanswer.value) {
    var Options = [
      {
        key: 'sequence1',
        sequence: (formData?.option1).replaceAll('"', "'"),
      },
      {
        key: 'sequence2',
        sequence: (formData?.option2).replaceAll('"', "'"),
      },
    ];
    ...
    OptionValues?.map((item, i) => {
      var GetOption = {
        key: 'sequence' + (i + 3),
        sequence: (item?.sequence).replaceAll('"', "'"),
      };
                ...
                <Row gutter={30} className="skillrow mb-space">
                  ...
                  <Col md={18} xs={24} className="skillrow-inner">
                    <div className="greencol">
                      <Form.Item name="option1" label="Sequence Item 1">
                        {/* <label>Sequence Item 1</label> */}
                        <CKEditor
                          editor={ClassicEditor}
                          contentStyle={{
                            height: 430,
                        ...
                        <Input className="exact_answer" type="radio"></Input>
                  ...
                  <Col md={18} xs={24} className="skillrow-inner">
                    <div className="greencol">
                      <Form.Item name="option2" label="Sequence Item 2">
                        {/* <label>Sequence Item 2</label> */}
                        <CKEditor
                          editor={ClassicEditor}
                          contentStyle={{
                            height: 430,
                  ...
                  {OptionValues?.map((item, index) => (
                    <Col md={18} xs={24} className="skillrow-inner">
                      <div className="greencol">
                        <Form.Item name="option-2" label={'Sequence Item' + (index + 3)} className="optionadd">
...
export default AddSquenceQuestion;
