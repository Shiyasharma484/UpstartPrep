              ...
              <Cards>
                <Row gutter={30} className="skillrow mb-space">
                      ...
                      >
                        ...
                        <div className="radio_button">
                          <Input
                            ...
                            name="answer"
                            checked={CheckedExactAnswer?.option1}
                            onChange={e => HandleAnswer(e, formData?.option1, 'option1')}
                          ></Input>
                  ...
                  {OptionValues?.map((item, index) => (
                    <Col md={18} xs={24} className="skillrow-inner">
                      <div className="greencol">
                        <Form.Item name="option-2">
                          <label>Acceptable Answer {index + 3}</label>
                          <CKEditor
                            name={'Option' + ' ' + (index + 3)}
                            id={'Option' + ' ' + (index + 3)}
                            editor={ClassicEditor}
...
export default Addshortquestion;
