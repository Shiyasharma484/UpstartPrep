...
import ModulesTable from './overview/ModulesTable';
    ...
    <>
      <CardToolbox>
        <PageHeader
          ...
          subTitle={
            <>
              <span className="title-counter">200 Users </span>
              <AutoComplete
          ...
          buttons={[
            <Button className="btn-add_new" size="default" type="primary" key="1">
              <Link to="/dashboard/users/add-user/info">+ Add New Module</Link>
            </Button>,
          ]}
        />
      </CardToolbox>
