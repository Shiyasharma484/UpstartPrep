      ...
      {AlreadyAttempted == false ? (
        <Main className="examQuestionPage">
          <Row className="exam-logo">
            <Col md={24} xs={24}>
              <NavLink className="pass-link Quiz-logo" to="/">
            ...
            <Col md={24}>
              <div className="tymremain">
                {ShowSubmitButton == true ? (
                  <Button
                    type="success"
                    style={{ color: '#fff', borderRadius: '5px', fontSize: '12px' }}
            ...
            <Row className="quizQRow">
              <Col md={17} style={{ paddingLeft: '5px', paddingRight: '5px' }}>
                <Row>
                  ...
                  <Col md={21} className="custom-remove-evenet" style={{ paddingLeft: '5px', paddingRight: '5px' }}>
              ...
              <Col md={7} className="quest_Btns" style={{ paddingLeft: '5px', paddingRight: '5px' }}>
                <div className="quest_Btns_pre_nxt"></div>
                ...
                <div className="text-left">
                  <Button className="BackButton" onClick={() => HandleComeBackLater()}>
                    Come Back Later
                  </Button>
                </div>
              </Col>
