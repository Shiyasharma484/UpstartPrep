...
import studyskills from '../../static/img/studyskills.png';
                    ...
                    <div className="header-main-right topnav header-main-right topnav" id="myTopnav">
                      <div className="header-nav">
                        <div className="main-menu">
                          <NavLink className={isActive ? '' : 'pass-links slide-animate mobsubclick'} to="/preppage">
                            <div
                        ...
                        <div className="main-menu">
                          <NavLink className={chooosemenu ? 'mobsubclick' : 'slide-animate pass-links'} to="/preppage">
                        ...
                        <div className="main-menu">
                          <NavLink className={testprepmenu ? 'mobsubclick' : 'homeMenus pass-links'} to="/preppage">
                            <div
                              className="flex-iconMenu"
                              onClick={() => {
                        ...
                        <div className="main-menu">
                          <NavLink className={Academicmenu ? 'mobsubclick' : 'slide-animate pass-links'} to="/preppage">
                            <div
                              className="flex-iconMenu"
                              onClick={() => {
              ...
              <Col md={10} className="featureEvents-main-inner">
                <div className="featureEvents-main-first">
                  ...
                  <span style={{ fontSize: '2em' }}>
                    <TypeAnimation
                      sequence={['easy', 1000, 'fast', 1000, 'efficient', 1000, 'simple', 1000]}
                      repeat={Infinity}
                    />
                  </span>
                </div>
