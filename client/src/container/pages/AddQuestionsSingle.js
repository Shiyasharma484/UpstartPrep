...
const AddQuestionsSingle = () => {
  ...
  const handlesubmit = (fieldsValue, name) => {
    ...
    if (exactanswer.key) {
      ...
      if (skills) {
        var meta = {};
        var payload = {
          questions: (formData?.question).replace(/(<([^>]+)>)/gi, ''),
          description: formData?.description,
          // options: JSON.stringify(Options),
          options: Options,
          skill: formData?.skill,
          // answers: JSON.stringify(exactanswer),
          answers: exactanswer,
        };
        meta = {
      ...
      // payload.options = payload.options.replace(
      //   '"http://www.w3.org/1998/Math/MathML"',
      //   "'http://www.w3.org/1998/Math/MathML'",
      // );
      // payload.answers = payload.answers.replace(
      //   '"http://www.w3.org/1998/Math/MathML"',
      //   "'http://www.w3.org/1998/Math/MathML'",
      // );
      if (skills) {
  ...
  const HandleSettingTab = name => {
    ...
    console.log(JSON.stringify(settingspayload));
      ...
      <Main>
        ...
        >
          <section className="SectionTabsMainTop">
            ...
            {tabpane?.Details == true ? (
              <Cards>
                <Row gutter={30} className="skillrow mb-space BankFields">
                  <Col md={18} xs={24} className="skillrow-inner" id="skills">
                    ...
                    <Form.Item name="description" label="Description" className="des-gallery">
                      ...
                      >
                        ...
                        <div className="radio_button">
                          <Input
                            ...
                            checked={CheckedExactAnswer?.option1}
                            onChange={e => {
                              HandleAnswer(e, formData?.option1, 'option1');
                            }}
                          ></Input>
                      ...
                      >
                        ...
                        <div className="radio_button">
                          <Input
                            ...
                            name="answer"
                            checked={CheckedExactAnswer?.option2}
                            onChange={e => HandleAnswer(e, formData?.option2, 'option2')}
                          ></Input>
                          <label>Correct Answer</label>
                        </div>
                      </Form.Item>
...
export default AddQuestionsSingle;
