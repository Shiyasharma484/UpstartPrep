          ...
          <Row>
            <Col md={24} className="main-analysisTabs">
              <div className="analysisTabs">
                <div className="view_res">
                  <p>
                    <span>12</span>
                    /50
                  </p>
                </div>
                <div className="border_r animate__animated animate__bounce" style={{ background: '#22374e' }}>
                  <Row>
                    <div className="MainResult">
                      <div className="firstRowResult">
                        <h1 style={{ color: '#fff' }}>ISEE UPPER #1</h1>
                      </div>
                    </div>
                  </Row>
                  <div class="tab_2">
                ...
                <div
                  id="Overview"
                  class="tabcontent border_r2"
                  style={{ display: 'block', backgroundColor: '#22374e' }}
                >
                  <Row>
                    <Col md={24}>
                      <div class=" tab_2 verticalTab">
                        <Row className="">
                          <Col md={5}>
                            <button
                              class="tablinks2 active clip_2 "
                              onClick={e => {
                            ...
                            <button class="tablinks2 clip_2" onClick={() => setIsBilling(true)}>
                              <div className="flexTab-Title  ">
                          ...
                          <Col md={19}>
                            <div id="schoolsapply" class="tabcontent3" style={{ display: 'block' }}>
                ...
                <div id="Verbal" class="tabcontent quantitiveDiv">
                  <VerbalReasoning data={ScoreData} />
                </div>

                <div id="QUANTITATIVE" class="tabcontent quantitiveDiv">
                  <QuantitativeReasoning />
                </div>

                <div id="Reading" class="tabcontent quantitiveDiv">
                  <ReadingComprehension />
                </div>

                <div id="Math" class="tabcontent quantitiveDiv">
