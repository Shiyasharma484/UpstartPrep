...
const AddQuestionType = () => {
  ...
  const handlesubmit = fieldsValue => {
    ...
    meta = {
      ...
      descripion: fieldsValue?.description,
    ...
    async function createentity() {
      ...
      if (response.status == 201) {
        ...
        setTimeout(() => {
          history.push('../users/question-types');
        }, 1000);
      } else {
  ...
  return (
    <>
      <Main>
        ...
        >
          <h1 style={{ fontSize: '25px', color: 'rgb(20 19 19)' }}>Add Questions Types</h1>
            ...
            <Cards>
              <Row gutter={30} className="skillrow">
                <Col md={8} xs={24}>
                  ...
                  >
                    <Input name="entity" type="text" placeholder="Enter Your Question Type "></Input>
                  </Form.Item>
                </Col>

                <Col md={8} xs={24} id="status">
